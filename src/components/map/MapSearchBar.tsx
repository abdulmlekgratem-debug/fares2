    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      <div className="flex items-center gap-2">
        ...
        <Button
          size="icon"
          variant="secondary"
          className="w-11 h-11 rounded-xl bg-card/95 backdrop-blur-md border-2 border-border/60 shadow-lg hover:bg-primary hover:text-primary-foreground transition-all duration-300 flex-shrink-0"
        ...
        <div className="relative group flex-1">
          {/* Glow effect */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/40 via-primary/60 to-primary/40 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity duration-300" />
          ...
          <div className="relative flex items-center">
            ...
            <Input
              ...
              className="pr-11 pl-10 text-right bg-card/95 backdrop-blur-md border-2 border-border/60 focus:border-primary rounded-xl py-3 text-sm font-medium text-foreground placeholder:text-muted-foreground shadow-lg transition-all duration-300"
            />
            ...
            {searchQuery && (
              <Button
                size="icon"
                variant="ghost"
                className="absolute left-2 top-1/2 -translate-y-1/2 h-7 w-7 rounded-lg hover:bg-destructive/20"
                onClick={() => {
                  setSearchQuery("")
                  setResults([])
                  setIsOpen(false)
