  ...
  return (
    <header className="relative min-h-[90vh] overflow-hidden">
      ...
      >
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black mb-2 md:mb-4 animate-fade-in-up animate-delay-200">
            <span className="text-primary">استعرض</span>
            <span className="text-white"> أفضل المواقع</span>
          </h1>
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black mb-4 md:mb-6 animate-fade-in-up animate-delay-300">
            <span className="text-primary">الإعلانية</span>
            <span className="text-white"> في المدينة</span>
          </h2>
          <p className="text-sm sm:text-base md:text-xl text-gray-300 mb-1 md:mb-2 animate-fade-in-up animate-delay-400">
            اكتشف لوحاتنا الإعلانية المتميزة في أفضل المواقع
          </p>
          <p className="text-xs sm:text-sm md:text-lg text-primary font-semibold animate-fade-in-up animate-delay-500">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 md:mb-12 px-2">
          <Button 
            className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-4 sm:px-6 md:px-8 py-3 md:py-6 text-sm md:text-lg rounded-xl shadow-gold animate-slide-in-right animate-delay-500"
          ...
          <Button 
            variant="outline"
            className="border-2 border-gray-400 text-white hover:bg-white/10 font-bold px-4 sm:px-6 md:px-8 py-3 md:py-6 text-sm md:text-lg rounded-xl animate-slide-in-left animate-delay-500"
        ...
        >
          <div 
            ...
            className="bg-card/60 backdrop-blur-sm border border-primary/30 rounded-lg md:rounded-xl px-4 sm:px-6 md:px-8 py-3 md:py-6 text-center min-w-[100px] sm:min-w-[120px] md:min-w-[150px] animate-fade-in-up animate-delay-600"
          >
            <Check className="w-4 h-4 md:w-6 md:h-6 text-primary mx-auto mb-1 md:mb-2" />
            <div className="text-xl sm:text-2xl md:text-3xl font-black text-white">{qualityCount.displayValue}</div>
            <div className="text-[10px] sm:text-xs md:text-sm text-gray-400">ضمان الجودة</div>
          </div>
          <div 
            ref={serviceCount.elementRef}
            className="bg-card/60 backdrop-blur-sm border border-primary/30 rounded-lg md:rounded-xl px-4 sm:px-6 md:px-8 py-3 md:py-6 text-center min-w-[100px] sm:min-w-[120px] md:min-w-[150px] animate-fade-in-up animate-delay-700"
          >
            <Clock className="w-4 h-4 md:w-6 md:h-6 text-primary mx-auto mb-1 md:mb-2" />
            <div className="text-xl sm:text-2xl md:text-3xl font-black text-white">{serviceCount.displayValue}</div>
            <div className="text-[10px] sm:text-xs md:text-sm text-gray-400">خدمة العملاء</div>
          </div>
          <div 
            ref={billboardsCount.elementRef}
            className="bg-card/60 backdrop-blur-sm border border-primary/30 rounded-lg md:rounded-xl px-4 sm:px-6 md:px-8 py-3 md:py-6 text-center min-w-[100px] sm:min-w-[120px] md:min-w-[150px] animate-fade-in-up animate-delay-800"
          >
            <MapPinned className="w-4 h-4 md:w-6 md:h-6 text-primary mx-auto mb-1 md:mb-2" />
            <div className="text-xl sm:text-2xl md:text-3xl font-black text-primary">{billboardsCount.displayValue}</div>
            <div className="text-[10px] sm:text-xs md:text-sm text-gray-400">لوحة متاحة</div>
          </div>
        </div>
