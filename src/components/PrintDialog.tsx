...
export default function PrintDialog({ isOpen, onClose, onPrint, billboards = [] }: PrintDialogProps) {
  ...
  const dialogContent = (
    <div
      className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-[1000001] overflow-y-auto"
      onClick={onClose}
    >
      <div
  ...
  // Use portal to ensure dialog appears above everything including fullscreen map.
  // If the browser Fullscreen API is used, we must render inside fullscreenElement.
